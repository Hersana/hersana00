         ...
         <div class="panel-body">
            ...
            <div class="row">
               <div class="col{!! $errors->has('melt_pump[]') ? 'has-error' : '' !!}">                  
                  ...
                  <div class="col-md-2">
                     {!! Form::number('melt_pump[]', $komposisidetail->melt_pump, ['min'=>'0', 'class'=>'form-control']) !!}
            ...
            <div class="row">
               <div class="form-inline {!! $errors->has('mat_com1[]') ? 'has-error' : '' !!}">                  
                  ...
                  <div class="col-md-3">
                     {!! Form::select('mat_com1[]', [''=>'-----']+App\Bahan::pluck('nama','id')->all(), $komposisidetail->mat_com1, ['class'=>'js-selectize']) !!}
                     {!! $errors->first('mat_com1[]', '<p class="help-block">:message</p>') !!}
                  </div>
                  {!! Form::number('per_com1[]', $komposisidetail->per_com1, ['min'=>'0', 'max'=>'100', 'class'=>'col-md-1 form-control']) !!}
               </div>
            </div>
            ...
            <div class="row">
               <div class="form-inline {!! $errors->has('mat_com2[]') ? 'has-error' : '' !!}">                  
                  ...
                  <div class="col-md-3">
                     {!! Form::select('mat_com2[]', [''=>'-----']+App\Bahan::pluck('nama','id')->all(), $komposisidetail->mat_com2, ['class'=>'js-selectize']) !!}
                     {!! $errors->first('mat_com2[]', '<p class="help-block">:message</p>') !!}
                  </div>
                  {!! Form::number('per_com2[]', $komposisidetail->per_com2, ['min'=>'0', 'max'=>'100', 'class'=>'col-md-1 form-control']) !!}
               </div>
            </div>
            ...
            <div class="row">
               <div class="form-inline {!! $errors->has('mat_com3[]') ? 'has-error' : '' !!}">                  
                  ...
                  <div class="col-md-3">
                     {!! Form::select('mat_com3[]', [''=>'-----']+App\Bahan::pluck('nama','id')->all(), $komposisidetail->mat_com3, ['class'=>'js-selectize']) !!}
                     {!! $errors->first('mat_com3[]', '<p class="help-block">:message</p>') !!}
                  </div>
                  {!! Form::number('per_com3[]', $komposisidetail->per_com3, ['min'=>'0', 'max'=>'100', 'class'=>'col-md-1 form-control']) !!}
               </div>
            </div>
            ...
            <div class="row">
               <div class="form-inline {!! $errors->has('mat_com4[]') ? 'has-error' : '' !!}">                  
                  ...
                  <div class="col-md-3">
                     {!! Form::select('mat_com4[]', [''=>'-----']+App\Bahan::pluck('nama','id')->all(), $komposisidetail->mat_com4, ['class'=>'js-selectize']) !!}
                     {!! $errors->first('mat_com4[]', '<p class="help-block">:message</p>') !!}
                  </div>
                  {!! Form::number('per_com4[]', $komposisidetail->per_com4, ['min'=>'0', 'max'=>'100', 'class'=>'col-md-1 form-control']) !!}
               </div>
            </div>
            ...
            <div class="row">
               <div class="form-inline {!! $errors->has('mat_com5[]') ? 'has-error' : '' !!}">                  
                  ...
                  <div class="col-md-3">
                     {!! Form::select('mat_com5[]', [''=>'-----']+App\Bahan::pluck('nama','id')->all(), $komposisidetail->mat_com5, [
                        'class'=>'js-selectize']) !!}
                     {!! $errors->first('mat_com5[]', '<p class="help-block">:message</p>') !!}
                  </div>
                  {!! Form::number('per_com5[]', $komposisidetail->per_com5, ['min'=>'0', 'max'=>'100', 'class'=>'col-md-1 form-control']) !!}
               </div>
            </div>
            ...
            <div class="row">
               <div class="form-inline {!! $errors->has('mat_com6[]') ? 'has-error' : '' !!}">                  
                  ...
                  <div class="col-md-3">
                     {!! Form::select('mat_com6[]', [''=>'-----']+App\Bahan::pluck('nama','id')->all(), $komposisidetail->mat_com6, [
                        'class'=>'js-selectize']) !!}
                     {!! $errors->first('mat_com6[]', '<p class="help-block">:message</p>') !!}
                  </div>
                  {!! Form::number('per_com6[]', $komposisidetail->per_com6, ['min'=>'0', 'max'=>'100', 'class'=>'col-md-1 form-control']) !!}
               </div>
            </div>
